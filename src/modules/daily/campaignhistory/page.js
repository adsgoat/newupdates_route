...
export default function CampaignAndAccount({ account, campaign_id, timezone, collection, userdetails, theme }) {
    ...
    const getCampaignData = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`/api/reportshistory/daily/campaign?accountNumber=${account}&timezone=${timezone}&network=${collection}&CampaignId=${campaign_id}`)
