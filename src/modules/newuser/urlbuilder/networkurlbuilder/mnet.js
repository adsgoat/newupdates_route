...
const MnetUrlBuilder = ({ defaultValues, indexValueForAccount, onReturnMessage, theme, showSubmitButton, accountis }) => {
  // Initial data array
  ...
  const onClickSubmit = () => {
    ...
    if (keywords && channel && domain && source && pixelId) {
      ...
      url = url
        ...
        .replace("business_code_replace_source_code_replace_region_code_replace", ad_id)
        .replace("campaign_id_replace", campaign_id)
        .replace("adset_id_replace", adset_id);
      onReturnMessage(url);
    }
    else {
    ...
    <div style={{ width: '100%' }}>
      ...
      <Row style={{ width: '100%' }}>
        <Col span={24}>
          ...
          <div style={{ width: '100%' }}>
            <SearchInput
              placeholder="Keywords" style={{ width: '100%', paddingRight: '2px' }}
      ...
      <Row justify="space-between" style={{ marginTop: '20px' }}>
        ...
        <Col>
          <SubmitButton onClick={onClickGet} text="Get"></SubmitButton>
          {!showSubmitButton && <SubmitButton text="Submit"></SubmitButton>}
        </Col>
      </Row>
