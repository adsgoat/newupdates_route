...
export default function CampaignAndAccount({ account, campaign_id, timezone, collection, userdetails, reportType, theme }) {
    ...
    return (
        ...
        >
            ...
            {showTables && (
                // <Col style={{ display: 'flex', width: '100%', marginLeft: '0%' }}>
                //     {/* Top 5 Dates with RPC */}
                //     <div style={{ width: '20%', marginLeft: '1%' }}>
                //         <p style={{ fontSize: 12, fontWeight: 500, color: theme === "dark" ? "white" : "black" }}>Top 5 dates with Rpc</p>
                //         <table
                //             style={{
                //                 width: '100%',
                ...
                //             <thead>
                //                 <tr>
                //                     <th style={{ fontWeight: 500, border: '1px solid #888', padding: '2px 4px', color: theme === "dark" ? "white" : "black" }}>
                //                         Date
                //                     </th>
                //                     <th style={{ fontWeight: 500, border: '1px solid #888', padding: '2px 4px', color: theme === "dark" ? "white" : "black" }}>
                //                         RPC
                ...
                //                     .map((item, index) => (
                //                         <tr key={index}>
                //                             <td style={{ border: '1px solid #888', padding: '2px 4px', color: theme === "dark" ? "white" : "black" }}>
                //                                 {item.date}
                //                             </td>
                //                             <td style={{ border: '1px solid #888', padding: '2px 4px', color: theme === "dark" ? "white" : "black" }}>
                //                                 {item.rpc}
                ...
                //     {/* Last 5 Dates with RPC */}
                //     <div style={{ width: '20%', marginLeft: '1%' }}>
                //         <p style={{ fontSize: 12, fontWeight: 500, color: theme === "dark" ? "white" : "black" }}>Last 5 dates with Rpc</p>
                //         <table
                //             style={{
                //                 width: '100%',
                //                 borderCollapse: 'collapse',
                ...
                //     {/* Top 5 Dates with Margin */}
                //     <div style={{ marginLeft: "1%", width: '20%' }}>
                //         <p style={{ fontSize: 12, fontWeight: 500, color: theme === "dark" ? "white" : "black" }}>Top 5 dates with margin</p>
                //         <table
                //             style={{
                //                 width: '100%',
                //                 borderCollapse: 'collapse',
                ...
                //     {/* Last 5 Dates with Margin */}
                //     <div style={{ marginLeft: "1%", width: '20%' }}>
                //         <p style={{ fontSize: 12, fontWeight: 500, color: theme === "dark" ? "white" : "black" }}>Last 5 dates with margin</p>
                //         <table
                //             style={{
                //                 width: '100%',
                //                 borderCollapse: 'collapse',
