...
const columnDefsObjectCampaign = {
    ...
    date: {
        headerName: 'Date', field: 'date', width: 170, sort: 'desc', pinned: "left",
    ...
    hour_f: {
        headerName: 'Hour_F', field: 'hour_f', width: 95,
        comparator: (valueA, valueB) => {
            if (valueA == null && valueB == null) return 0;
            if (valueA == null) return -1;
            if (valueB == null) return 1;
    ...
    hour_n: {
        headerName: 'Hour_N', field: 'hour_n', width: 95,
        comparator: (valueA, valueB) => {
            if (valueA == null && valueB == null) return 0;
            if (valueA == null) return -1;
            if (valueB == null) return 1;
    ...
    date_f: {
        headerName: 'Date', field: 'date_f', width: 90, sort: 'asc',
        comparator: (valueA, valueB) => {
            if (valueA == null && valueB == null) return 0;
            if (valueA == null) return -1;
            if (valueB == null) return 1;
    ...
    date_n: {
        headerName: 'Date', field: 'date_n', width: 80, sort: 'asc',
        comparator: (valueA, valueB) => {
            if (valueA == null && valueB == null) return 0;
            if (valueA == null) return -1;
            if (valueB == null) return 1;
